...
namespace OpenXmlPowerTools
{
    ...
    public static class FlatOpc
    {
        ...
        /// </summary>
        public static readonly XProcessingInstruction WordDocument =
            new XProcessingInstruction("mso-application", "progid=\"Word.Document\"");

        /// <summary>
        /// Processing instructions for PowerPoint document.
        /// </summary>
        public static readonly XProcessingInstruction PowerPointShow =
        ...
        static XProcessingInstruction GetProcessingInstruction(string fileName)
        {
        ...
        /// <returns></returns>
        public static XDocument OpcToFlatOpc(string fileName)
        {
            using (Package package = Package.Open(fileName))
                return OpcToFlatOpc(package, GetProcessingInstruction(fileName));
        }
        ...
        /// </summary>
        /// <param name="doc">The document in Flat OPC format</param>
        /// <param name="fileName">The file in OPC format</param>
        public static void FlatOpcToOpc(XDocument doc, string fileName)
        {
